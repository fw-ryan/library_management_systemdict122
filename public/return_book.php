...
$stmt = $conn->prepare("UPDATE books SET available_copies = available_copies + 1 WHERE id = ?");$stmt->bind_param("i", $book_id);
if ($stmt->execute()) {
// Set success message for book return
$_SESSION['message'] = "Book returned successfully!"; } else {
