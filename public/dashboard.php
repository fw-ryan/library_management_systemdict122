...
$user_stmt = $conn->prepare("SELECT name, email FROM users WHERE id = ?"); $user_stmt->bind_param("i", $user_id);
$user_stmt->execute();
...
<!-- Display borrowed books if any --> <?php if (!empty($borrowed_books)): ?>
<table>
<thead>
<tr>
<th>Title</th>
<th>Author</th>
<th>Borrowed At</th> <th>Due Date</th> <th>Returned At</th> <th>Action</th>
</tr></thead>
<tbody>
<!-- Display borrowed books -->
<?php foreach ($borrowed_books as $borrowed_book): ?> <tr>
<td><?php echo
...
<!-- Form to return borrowed book --> <form method="POST"
...
<th>Title</th>
<th>Author</th>
<th>Publication Year</th> <th>Available Copies</th><th>Action</th>
</tr>
</thead>
<tbody>
...
<td>
<?php if ($book['available_copies'] > 0): ?> <!-- Form to borrow a book -->
<form method="POST"
...
<button class="button"
onclick="window.location.href='index.php'">Back to Home</button> </div>
</body> 
</html>